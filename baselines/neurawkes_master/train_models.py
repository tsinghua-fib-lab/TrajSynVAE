...
from .modules import utils, models, optimizers, controllers, data_processers
...
def main(args):
    ...
    if 'meme' in args.FileData:
        ...
        tag_track = ''
    #
    path_track = '.Data_for_Hawakes/tracks'+ tag_track +'/'
    file_log = os.path.abspath(
        path_track + 'log.txt'
    )
    #path_save = os.path.abspath(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str, default='./data/data_meme',
